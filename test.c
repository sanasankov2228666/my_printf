...
int main(void)
{
    ...
    printf("=== 1. 20 FLOATS WITH DIFFERENT SIGNS + NAN/INF ===\n\n");
    
    my_printf("%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n", 
        3.14, -2.71, NAN, -1.73, 2.718, INFINITY, 0.5, -0.25, 100.1, -200.2,
        0.001, -0.001, 12345.67, INFINITY, 0.0001, -0.0001, 9999.99, -8888.88,
        7777.77, NAN);
